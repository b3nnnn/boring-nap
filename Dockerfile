FROM ubuntu:18.04
LABEL org.opencontainers.image.source="https://github.com/b3nnnn/boring-nap"
...
RUN set -x \
    ...
    # Install prerequisite packages, vim for editing, then Install NGINX Plus App Protect
